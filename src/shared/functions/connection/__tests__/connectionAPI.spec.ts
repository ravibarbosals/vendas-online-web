...
import MockApdapter from 'axios-mock-adapter';

import { ERROR_ACCES_DANIED, ERROR_CONNECTION } from '../../../constants/errorsStatus';
...
const mockAxios = new MockApdapter(axios);
